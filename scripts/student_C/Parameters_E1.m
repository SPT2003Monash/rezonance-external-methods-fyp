...
P_inj = 0;                 % Active power injection MW
Q_inj = 0;                 % Reactive power injection MVAR
...
k_pi = 0.31831*Zb;          % Proportional gain of current controller
k_ii = 25*Zb;            % Integral gain of current controller
beta_v = 1;                % Voltage feedforward gain factor

%% Voltage Control Parameters (TO change and modify)
k_pv = 0.764366/Zb;            % Proportional gain of voltage controller
k_iv = 2/Zb;     % Integral gain of voltage controller
...
save('Parameters_E1.mat', 'f_base', 'f_sample','f_step', 'wn', 'w','V_LL', 'S_base', 'Zb', 'Vdc', 'Lb', ...
     'fsw', 'td', 'lf1', 'rf1', 'lf2', 'rf2','cf', 'rd', 'SCR', 'XR', 'rgpu', 'lgpu', 'rg', 'lg', 'k_pi', 'k_ii', ...
     'beta_v', 'k_pv','k_iv','beta_i', 'cs','rs', 'P_inj', 'Q_inj', ...
